...
.then(() => database.none(
    ...
    + ', '
    + 'likerusername VARCHAR(255) NOT NULL'
    + ', '
    + 'likedusername VARCHAR(255) NOT NULL'
    + ', '
    + 'likerpicture VARCHAR(255) NOT NULL'
    + ', '
    + 'likedpicture VARCHAR(255) NOT NULL'
    + ', '
    + 'created TIMESTAMP DEFAULT CURRENT_TIMESTAMP'
    + ","
...
.then(() => database.none(
    ...
    + ', '
    + 'blockedusername VARCHAR(255) NOT NULL'
    + ', '
    + 'created TIMESTAMP DEFAULT CURRENT_TIMESTAMP'
    + ')'
)
.then(() => database.none(
    ...
    + ', '
    + 'viewerusername VARCHAR(255) NOT NULL'
    + ', '
...
.then(() => database.none(
    ...
    + ', '
    + "gender VARCHAR(255) NOT NULL DEFAULT 'non binary'"
    + ', '
